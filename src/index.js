...
// --- REVISI: KOP SURAT DIHAPUS DARI SINI ---
// Variabel pdfHeaderTemplateIdentifikasi dan pdfHeaderTemplateInspeksi
// tidak lagi diperlukan di sini. Kita akan memindahkannya ke EJS.
// --- AKHIR REVISI ---
...
        const data = doc.data();
        
        // REVISI: Logika pemilihan header dihapus
        
        const templatePath = path.join(__dirname, 'template-laporan-content-only.ejs');
        // Kirim logoDataUrl ke template EJS agar bisa digunakan di sana
        const html = await ejs.renderFile(templatePath, { 
            data: data, 
            formatDate: formatDate,
            logoDataUrl: logoDataUrl // <-- REVISI BARU
        }); 
...
            displayHeaderFooter: false, // <-- REVISI: Matikan header/footer bawaan
            // REVISI: Hapus header/footer template
            // REVISI: Margin normal, karena header/footer sudah jadi bagian konten
...
                const pdfBuffer = await page.pdf({
                    format: 'A4', landscape: true, printBackground: true,
                    displayHeaderFooter: false, // <-- REVISI: Matikan
                    // REVISI: Hapus header/footer template
                    margin: { top: '25px', bottom: '30px', left: '25px', right: '25px' }, // <-- REVISI Margin
                    timeout: 60000
                });
